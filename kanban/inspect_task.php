            ...
            <div style="width:75%;">
                ...
                <div style="padding: 50px 0px 0px 200px;">
                    ...
                    <div style="display:flex; gap: 15px;">
                        <div class="assignee">
                            <img src= "../assets/assignee_icon.svg" style="width: 15px; padding-bottom: 3px;"/>
                            <h2>Assigned To: Jane Doe</h2>
                        </div>
                        <button type="button" class="btn btn-outline-warning log-btn" style="padding: 10px 15px 0px 2px;border: none">
