                ...
                <div class="mt-5" style="padding: 50px 100px 0px 200px;">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        <div style="width: 25%">
                            ...
                            <select name="assignee" id="assignee" class="form-control form-control-sm assign-to" style="margin-top: 5px">
                                <option value="<?= NULL ?>" <?= $currentAssigneeId === NULL ? 'selected' : '' ?>>None</option>
                                <?php
                                foreach ($users as $user) {
                                    $selected = (htmlspecialchars($user->user_id) == $currentAssigneeId) ? 'selected' : '';
                                    ?>
                                    <option value="<?= htmlspecialchars($user->user_id) ?>" <?= $selected ?>><?= htmlspecialchars($user->user_fname . ' ' . $user->user_lname) ?></option>
                                    <?php
                                }
                                ?>
                            </select>
